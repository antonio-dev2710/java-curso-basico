...
public class Questao2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("O maior número é: "+ maior5+", O menor número é: "+menor5 +" linha: "+linha5 );
	
		System.out.println("O maior número é: "+ maior7+", O menor número é: "+menor7 +" coluna "+coluna7);
	}
